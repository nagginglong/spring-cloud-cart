...
public class SwaggerConfig {
    ...
    private ApiInfo createAI(){
        return new ApiInfoBuilder().title("购物车项目的在线接口文档").//设置标题
                contact(new Contact("Nagginglong","http://baidu.com","nagginglong@gmial.com"))
    ...
    public Docket createD(){
        return new Docket(DocumentationType.SWAGGER_2).//指定生成那种类型的文档
                ...
                .select().apis(RequestHandlerSelectors.basePackage("com.nagginglong.controller")).//扫描接口所在的包
                        build();
    }
}